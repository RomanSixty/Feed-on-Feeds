...
if (!file_exists(__DIR__ . '/vendor/autoload.php')) {
    die('Missing Composer dependencies. Please ensure that you have installed <a href="https://getcomposer.org/">composer</a> and run <tt>composer install</tt>.');
}
...
try {
    ...
    die("Dependency check failed; did you run <tt>composer install</tt>?<p>$ex");
}
